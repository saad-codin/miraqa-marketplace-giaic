  ...
  return (
    <div className="relative w-full h-[716px] flex items-center justify-center">
      ...
      <div className="absolute right-0 w-[90%] max-w-[643px] h-auto p-6 bg-[#FFF3E3] text-center md:text-left md:p-10 md:right-10 lg:right-20">
        ...
        <p className="text-base md:text-xl leading-[24px] font-semibold mt-2">Transform your space with timeless designs. Discover handcrafted furniture that blends style, comfort, and durability, perfect for every home. </p> 
         <Link href="/products"><button className="mt-6 w-full md:w-[222px] h-[60px] md:h-[74px] border border-[#B88E2F] text-white bg-[#B88E2F] text-lg font-medium">BUY NOW</button> </Link>
      </div>
    </div>
  );
}